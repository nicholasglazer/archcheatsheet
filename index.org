#+TITLE: Arch Linux no DE(Xmonad) install guide
#+AUTHOR: Nicholas Glazer
#+EMAIL: glazer.nicholas@gmail.com
# #+DATE: 2016-08-25

#+DESCRIPTION: This is Arch Linux no desktop environment install guide.
#+KEYWORDS: arch, archlinux, quick reference, cheat sheet, recommended practices, arch intall guide, arch linux manual, no desktop environment, arch cheat sheet, xmonad, xmobar, window manager
#+LANGUAGE: en
...
#+HTML: <div class="right"><a href="https://github.com/NicholasGlazer/arch-cheat-sheet" class="fa fa-github"> Edit on GitHub</a></div>

-----

#+name: Arch
#+attr_html: :align center
[[file:img/arch-logo.png]]
* Preparations
...
** Live USB
   ...
   If you want solo archlinux skip this. You can use [[https://wiki.archlinux.org/index.php/Wine][wine]] to open ~.exe~ files from linux.
   #+end_attention
*** BIOS config
...
** Bootloader
   ...
   pacman -S refind-efi
   #+END_SRC
   #+caption: After customization should look like this.
   [[file:img/refind.png]]
*** Install refind:
...
*** Media tools
   ...
   - CLI ::
            ...
            yay -S mpv
            #+END_SRC
            #+caption: mpv float and with accordion layout
...
** Xmonad configuration
   Xmonad is written in [[https://wiki.archlinux.org/index.php/Haskell][Haskell]], minimalistic and powerfull window manager with a lot of hackable features, though its configuration could be tricky if it's your first experience with functional programming language.
   No worries, it's not that hard, you can make [[https://wiki.archlinux.org/index.php/Xmonad#Configuration][simple configuration in a minutes with arch wiki.]] For the better understanding you may want to read [[http://beginners-guide-to-xmonad.readthedocs.io/index.html][beginners tutorial]]. \\
   ...
   #+caption: .dotfiles/.xmonad/xmonad.hs
...
*** Status bar (XMobar)
    ...
    #+caption: .dotfiles/.config/xmobar/xmobarrc
    [[file:img/xmobar.gif]]
*** Vim
