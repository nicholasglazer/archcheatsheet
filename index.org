...
**** Nodejs
     ...
     #+END_SRC
***** yarn
      Facebook has made a replacement for npm - [[https://github.com/yarnpkg/yarn][yarn]].
      It looks like faster solution with more features. \\
      You can install in in several ways:
      #+BEGIN_SRC sh
      pacaur -S yarn --noconfirm
      #+END_SRC
      or
      #+BEGIN_SRC sh
      npm i -g yarn
      #+END_SRC
      Read more in [[https://code.facebook.com/posts/1840075619545360][facebook's blog]].
***** npm
